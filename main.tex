...
The salary review for doctoral candidates at KTH is now based on time-based progression. For detailed information about the salary ladder and how salary increases are determined, refer to the official KTH collective agreement document: \url{https://intra.kth.se/polopoly_fs/1.1470266.1776426761!/HS-2026-0566%20Lokalt%20kollektivavtal%20om%20l%C3%B6nestege%20f%C3%B6r%20doktorander%20vid%20KTH%20-%20signerat.pdf}

Previously, the review was based on reaching 30, 50 or 80\% of your research objective, but this has been replaced by a time-based system. The PhDChapter framework below can still be useful for tracking your research progress:
...
\subsection{Delivery}
If you need to receive any delivery at your office you can use the following delivery address:\\
Kungliga Tekniska Högskolan\\
SCI - Department of Engineering Mechanics\\
att: [Your name]\\
Teknikringen 8D\\
114 28 Stockholm\\
...
If you need non-emergency medical attention, visit your local healthcare centre (\textit{vårdcentral}).
You can call 1177 for medical advice. Dental care has a cost ceiling (\textit{högkostnadsskydd}). All universities have an occupational healthcare provider; check with your department to access it.
...
\subsection{Equality, Diversity and Equal Conditions (JML)}
JML (\textit{Jämlikhet, Mångfald och Lika villkor} — Equality, Diversity and Equal Conditions) is a mandatory course at KTH that all PhD students and faculty members are required to complete. It covers KTH's framework for creating an inclusive and non-discriminatory work and study environment, addressing topics such as equal treatment, harassment, and how to act when witnessing or experiencing problems.

Beyond the formal course, KTH is committed to fostering an inclusive work environment on a day-to-day basis. Two resources are particularly useful for PhD students in this area:

\textbf{Dare to Care} is a program run jointly by KTH and the student union aimed at promoting a healthy and respectful academic culture. The six-point list on the program page summarises practical ways in which individuals can act to support one another, drawing on insights from dedicated workshops: \url{https://www.kth.se/en/om/equality/daretocare-1.1428439}.

The \textbf{SCI Expectation Form} provides a structured basis for conversations between supervisors, postdocs, and PhD students about mutual expectations. Going through the form together at an early stage of the supervision relationship can help prevent misunderstandings and conflicts: \url{https://intra.kth.se/polopoly_fs/1.1424041.1757927324!/ExpectationForm_SCI.pdf}.
...
\subsection{Meals with or without tax benefits}
...
\subsubsection{Meals without tax benefit}

Applies to meals that you have been offered and that are tax-free benefit:

\begin{itemize}
    \item Hotel breakfast which is mandatorily included in the room price (i.e. you cannot opt out of it from the price).
    \item Meal that is included in the ticket price (i.e. you cannot opt out of the price).
    \item Internal/external representation, internal staff conferences or internal training (maximum 7 days).
\end{itemize}
...
\subsubsection{Meals with tax benefit}

Applies to meals that you have not paid for yourself, and which are taxable benefit, for example:

\begin{itemize}
    \item When you are at a conference/external training where lunch and dinner are included in the conference price. In this case, KTH has paid for the meals.
\end{itemize}

\section{Research Ethics by Emanuele D'Allestro}
\label{sec:ethics}

Ethics refers to the moral principles that govern behavior, guiding individuals and organizations in distinguishing right from wrong.
In the context of technology, ethical considerations ensure innovations respect human rights, promote fairness, and minimize harm. As technological influence grows, grounding decisions in strong ethical frameworks becomes essential for fostering trust and accountability within society.



For more information about the new expenses system visit here: https://intra.kth.se/en/anstallning/utlagg-och-reseersattningar/guider-kth-expense/kom-igang-med-kth-expense-1.1442819
